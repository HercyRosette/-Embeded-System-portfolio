...
potentiometer, transistor/relay stage, override button, and status LED were each verified indi
vidually. The combined sketch only responds to a sound trigger when the LDR indicates dark
